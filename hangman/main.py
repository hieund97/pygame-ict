...
# Hint button
hint_button = pygame.Rect(WIDTH - 150, 20, 120, 60)
...
def draw():
    ...
    win.blit(hint_text,
             (hint_button.x + (hint_button.width - hint_text.get_width()) / 2, hint_button.y +
              (hint_button.height - hint_text.get_height()) / 2))
